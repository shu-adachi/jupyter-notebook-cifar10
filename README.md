...
このハンズオンは、Watson Studioの操作感を実感し、その価値をご理解いただくことを目的としています。<br/>
以下のような目的をカバーするものではないことはご理解ください。
- JupyterNotebook、Pythonおよび利用するライブラリを網羅的に習得
...
[こちらのページ](./cifar-10_cnn.ipynb)へ移動してください。
